...
# Get the centroid of BRAF M and RAS M data
```{r,message=FALSE,warning=FALSE}
...
Briefly, we computed the centroids of the top 100 DE gene signature in B, c(B), and R, c(R), and for each tumor t we defined the BRAFV600E-RAS score (BRS) of t as the difference between the distance of t from c(B) and c(R):
